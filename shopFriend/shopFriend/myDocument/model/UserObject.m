...
+(BOOL)saveNewUser:(UserObject*)aUser
{
    ...
    NSString *insertStr=@"INSERT INTO 'SFUser' ('userId','nickName','description','userHead','friendFlag') VALUES (?,?,?,?,?)";
...
{
    NSString *createStr=@"CREATE  TABLE  IF NOT EXISTS 'SFUser' ('userId' VARCHAR PRIMARY KEY  NOT NULL  UNIQUE , 'nickName' VARCHAR, 'description' VARCHAR, 'userHead' VARCHAR,'friendFlag' INT)";
